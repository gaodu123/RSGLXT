...
<br><br><br><br><br><br><br>
 <form class="navbar-form navbar-center" action="index-chaxun.php" method="get" enctype="multipart/form-data">
           <div class="form-group">
           <h3>请输入要修改密码的用户职工号</h3><br>
              <input name="qx_id" type="text" class="form-control" placeholder="请输入职工号">
              <button type="submit" class="btn btn-default" style="background: #55AA00; color: #FFFFFF">前往修改</button>
           </div>
