...
echo ' <html>
  ...
  <div class="row">
    ...
    <br> <br> <br> <br> <br> <br> <br> <br>
     <div class="col-sm-9 mx-5" style="background:url(https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1592539359371&di=5fab8e2be659f9d666c2b6561fee930f&imgtype=0&src=http%3A%2F%2Fhbimg.b0.upaiyun.com%2F08084d2625b7f4cfcd748914c6223f247621a8be3d34-IRcJ5H_fw658);
    background-size:100% 100%;
    background-repeat:no-repeat;
   "><br> <br><br><br><br><br><br>
   
      <h2  > 小样，没登陆就想进来？&nbsp;&nbsp;<h5>  <div class="panel-body">
      <a href="http://localhost:81/RSGLXT/index.php" style="color:red;"> 快点我进行登录！！</a>
    </div></h5></h2>
...
?></p>
    ...
    <div>
       ...
       <!--向右对齐-->
        ...
        <p class="navbar-text navbar-right " style="color:  #FFFFFF">系统管理员</p>&nbsp;
...
<!--左侧导航栏-->
   <table width="100%" >
    <tr >
    <td valign="top" style="background: #F5F5F5"  width="10%" height="620">
    <div class="menu-list">
    <ul style="background: #AAAAAA">
       
        <li class="first-menu" >
            <a href="javascript:;" >  <span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;用户管理&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <span class="glyphicon glyphicon-chevron-down"></span></a>
           
<ul>
                <li class="second-menu">
                    <a href="yonghu/yonghu/quanxian_quanxian.php" target="leftifr" >用户权限管理</a>
                </li>
        ...
        <li class="first-menu">
            <a href="javascript:;"><span class="glyphicon glyphicon-lock"></span>&nbsp;&nbsp;密码设置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <span class="glyphicon glyphicon-chevron-down"></span></a>
            <ul>
                <li class="second-menu">
                    <a href="xgmm/index.php" target="leftifr">修改用户密码</a>
                </li>
    ...
    <!-- 右侧内容 -->
        <td width="80%"><iframe width="100%" height="620" frameborder="0" marginheight="0" marginwidth="0" name="leftifr"  src='yonghu/yonghu/quanxian_quanxian.php'>
