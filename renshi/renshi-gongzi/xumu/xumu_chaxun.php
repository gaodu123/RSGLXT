...
<br>
	...
	<br>
<h3    align="center"><?php echo $arr["xm_name"] ?>&nbsp;工资信息</h3>
<br>
<form action="xumu.php" method="post" enctype="multipart/form-data">
  ...
  <tr align="center">
        ...
        <tr align="center">
			...
			<td >身份证号</td>
			<td colspan="3"><?php echo $arr["xm_sfzh"] ?></td>
		...
		<tr align="center">
			<td >基本工资</td>
			<td colspan="2"><?php echo $arr["xm_jbgz"] ?></td>
			<td >岗位工资</td>
			<td colspan="2"><?php echo $arr["xm_gwgz"] ?></td>
			
            
		</tr>
		<tr align="center">
			<td>绩效</td>
			<td ><?php echo $arr["xm_jixiao"] ?></td>
			<td>请假扣款</td>
			<td ><?php echo $arr["xm_qjiakk"] ?></td>
			<td >医疗社保</td>
			<td ><?php echo $arr["xm_ylsb"] ?></td>
			
		</tr>
		<tr align="center">
			<td>奖金</td>
			<td ><?php echo $arr["xm_jiangjin"] ?></td>
			
			<td>发放日期</td>
			<td colspan="3"><?php echo $arr["xm_ffny"] ?></td>
			
		</tr>
		<tr align="center">
			
			<td>实发工资</td>
			<td colspan="5" ><?php echo $arr["xm_sfgz"] ?></td>
