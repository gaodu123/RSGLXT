...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="xinxi/xinxi.php" target="topifr">信息技术分院</a></li>
        <li><a href="xiandai/xiandai.php" target="topifr">现代农业分院</a></li>
        <li><a href="yuanlin/yuanlin.php" target="topifr">园林园艺分院</a></li>
        <li><a href="xumu/xumu.php" target="topifr">畜牧兽医分院</a></li>
        <li><a href="chengjian/chengjian.php" target="topifr">城乡建设分院</a></li>
        <li><a href="jinguan/jinguan.php" target="topifr">经济管理分院</a></li>
        <li><a href="jidian/jidian.php" target="topifr">机电技术分院</a></li>
    </ul>
</div>
  </div>
</div>
...
<tr>
    ...
    <!-- 右侧内容 -->
        <td width="80%"><iframe width="100%" height="600" frameborder="0" marginheight="0" marginwidth="0" name="topifr"  src='xinxi/xinxi.php'>
