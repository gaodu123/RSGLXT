        ...
        <form action="jidian_add.php" method="post" enctype="multipart/form-data">
          <table class="table">
           ...
           <tr>
             ...
             <tr>
              <th>基本工资：</th>
              <td><input type="text" name="jd_jbgz"></td>
            </tr>
            
             <tr>
              <th>岗位工资：</th>
              <td><input type="text" name="jd_gwgz" ></td>
            </tr>
           
           
            <tr>
              <th>绩效：</th>
              <td><input type="text" name="jd_jixiao" ></td>
            </tr>
            <tr>
              <th>请假扣款：</th>
              <td><input type="text" name="jd_qjiakk" ></td>
            </tr>
            <tr>
              <th>医疗社保：</th>
              <td><input type="text" name="jd_ylsb" ></td>
            </tr>
             <tr>
              <th>奖金：</th>
              <td><input type="text" name="jd_jiangjin" ></td>
            </tr>
            <tr>
              <th>实发工资：</th>
              <td><input type="text" name="jd_sfgz" ></td>
            </tr>

            <tr>
              <th>发放日期：</th>
              <td><input type="text" name="jd_ffny" ></td>
            </tr>
            <tr>
              <th></th>
              <td>
...
$sql = "SELECT * FROM renshi_gz_jd LIMIT $start_from, $num_rec_per_page"; 
...
?> 
            ...
            <td align="center"><?php echo $row['jd_sfzh']; ?></td> 
              <td align="center"><?php echo $row['jd_jbgz']; ?></td>   
            <td align="center"><?php echo $row['jd_gwgz']; ?></td>   
            <td align="center"><?php echo $row['jd_jixiao']; ?></td>   
            <td align="center"><?php echo $row['jd_qjiakk']; ?></td> 
             <td align="center"><?php echo $row['jd_ylsb']; ?></td>  
               <td align="center"><?php echo $row['jd_jiangjin']; ?></td>   
            <td align="center"><?php echo $row['jd_sfgz']; ?></td>  
             <td align="center"><?php echo $row['jd_ffny']; ?></td>   
