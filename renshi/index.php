...
?></p>
    ...
    <div>
        ...
        <p class="navbar-text navbar-right " style="color:  #FFFFFF">人事管理员</p>&nbsp;
...
<!--左侧导航栏-->
   <table width="100%" >
    ...
    <ul style="background: #AAAAAA">
        ...
        <li class="first-menu" >
            <a href="javascript:;" ><span class="glyphicon glyphicon-tasks"></span>&nbsp;&nbsp;教职工管理  &nbsp;&nbsp;&nbsp;  <span class="glyphicon glyphicon-chevron-down"></span></a>
            <ul>
                <li class="second-menu">
                    <a href="renshi-jzg/renshi_quanxian.php" target="leftifr" >教职工信息</a>
                </li>
                
            </ul>
        </li>
        <li class="first-menu">
            <a href="javascript:;">    <span class="glyphicon glyphicon-folder-open"></span>&nbsp;&nbsp;考勤管理&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <span class="glyphicon glyphicon-chevron-down"></span></a>
            <ul>
                <li class="second-menu">
                    <a href="renshi-kaoqin/kaoqin-rc/rc_quanxian.php" target="leftifr" >日常考勤</a>
                </li>
                <li class="second-menu">
                    <a href="renshi-kaoqin/kaoqin-qj/qj_quanxian.php" target="leftifr">请假登记</a>
                </li>
                 <li class="second-menu">
                    <a href="renshi-kaoqin/kaoqin-cc/cc_quanxian.php" target="leftifr">出差登记</a>
                </li>
            </ul>
        </li>
        <li class="first-menu">
            <a href="javascript:;">  <span class="glyphicon glyphicon-calendar"></span>&nbsp;&nbsp;绩效管理&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <span class="glyphicon glyphicon-chevron-down"></span></a>
            <ul>
                <li class="second-menu">
                    <a href="renshi-jixiao/jixiao_quanxian.php" target="leftifr">绩效考评消息</a>
                </li>
         ...
         <li class="first-menu">
            <a href="javascript:;"><span class="glyphicon glyphicon-tower"></span>&nbsp;&nbsp;工资管理&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <span class="glyphicon glyphicon-chevron-down"></span></a>
            <ul>
              
                <li class="second-menu">
                    <a href="renshi-gongzi/gz_index.php" target="leftifr">工资信息</a>
                </li>
    ...
    <!-- 右侧内容 -->
        <td width="80%"><iframe width="100%" height="620" frameborder="0" marginheight="0" marginwidth="0" name="leftifr"  src='renshi-jzg/renshi_quanxian.php'>
