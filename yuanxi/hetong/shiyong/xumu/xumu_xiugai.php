...
$xm_id = $_GET['xm_id'];
//编写查询sql语句
$sql = "SELECT * FROM `yuanxi_syht_xm` WHERE `xm_id`=$xm_id";
//执行查询操作、处理结果集
				...
				<form action="xumu_two.php" method="post" enctype="multipart/form-data">
					<table class="table">
                      ...
                      <tr>
						...
						<tr>
							<th>试用天数：</th>
							<td><input type="text" name="xm_syts" size="11" value="<?php echo $arr["xm_syts"] ?>"></td>
						</tr>

                      
                        <tr>
							<th>起始日期：</th>
							<td><input type="text" name="xm_qsrq" size="25" value="<?php echo $arr["xm_qsrq"] ?>"></td>
						</tr>
						...
						<tr>
							<th>终止日期：</th>
							<td><input type="text" name="xm_zzrq" size="25" value="<?php echo $arr["xm_zzrq"] ?>"></td>
						</tr>
