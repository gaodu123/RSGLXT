        ...
        <form action="xumu_add.php" method="post" enctype="multipart/form-data">
          <table class="table">
           ...
           <tr>
             ...
             <tr>
              <th>试用天数：</th>
              <td><input type="text" name="xm_syts" ></td>
            </tr>
           
           
            <tr>
              <th>试用起始日期：</th>
              <td><input type="text" name="xm_qsrq" ></td>
            </tr>
            <tr>
              <th>试用终止日期：</th>
              <td><input type="text" name="xm_zzrq" ></td>
            </tr>
            <tr>
              <th>试用工资：</th>
...
$sql = "SELECT * FROM yuanxi_syht_xm LIMIT $start_from, $num_rec_per_page"; 
...
?> 
            ...
            <td align="center"><?php echo $row['xm_syts']; ?></td>   
            <td align="center"><?php echo $row['xm_qsrq']; ?></td>   
            <td align="center"><?php echo $row['xm_zzrq']; ?></td> 
