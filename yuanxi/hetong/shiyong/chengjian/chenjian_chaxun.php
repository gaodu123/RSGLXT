...
<form action="chenjian.php" method="post" enctype="multipart/form-data">
  ...
  <tr align="center">
			...
			<td><?php echo $arr["cj_gender"] ?></td>
			<td colspan="2" rowspan="3" >头像</td>
		</tr>
		<tr align="center">
			<td bgcolor="#ededed">年龄</td>
			<td><?php echo $arr["cj_age"] ?></td>
        ...
        <tr align="center">
			...
			<td colspan="2"><?php echo $arr["cj_sfzh"] ?></td>
			<td bgcolor="#ededed">联系方式</td>
			<td colspan="2"><?php echo $arr["cj_phone"] ?></td>
			
		</tr>
	
		<tr align="center">
			<td bgcolor="#ededed">试用天数</td>
			<td ><?php echo $arr["cj_syts"] ?></td>
			<td bgcolor="#ededed">试用起始日期</td>
			<td colspan="2"><?php echo $arr["cj_qsrq"] ?></td>
            <td bgcolor="#ededed">试验终止日期</td>
			<td ><?php echo $arr["cj_zzrq"] ?></td>
		</tr>
		<tr align="center">
			<td bgcolor="#ededed">试用工资</td>
			<td colspan="6"><?php echo $arr["cj_salary"] ?></td>
