				...
				<form action="yunalin_two.php" method="post" enctype="multipart/form-data">
					<table class="table">
                      ...
                      <tr>
						...
						<tr>
							<th>试用天数：</th>
							<td><input type="text" name="yl_syts" size="11" value="<?php echo $arr["yl_syts"] ?>"></td>
						</tr>

                      
                        <tr>
							<th>起始日期：</th>
							<td><input type="text" name="yl_qsrq" size="25" value="<?php echo $arr["yl_qsrq"] ?>"></td>
						</tr>
						...
						<tr>
							<th>终止日期：</th>
							<td><input type="text" name="yl_zzrq" size="25" value="<?php echo $arr["yl_zzrq"] ?>"></td>
						</tr>
