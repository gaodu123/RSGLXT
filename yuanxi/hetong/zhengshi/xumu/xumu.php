      ...
      <div class="add">
        <form action="xumu_add.php" method="post" enctype="multipart/form-data">
          <table class="table">
           ...
           <tr>
              <th>姓　　别：</th>
              <td><input type="text" name="xm_gender"  ></td>
            </tr>
            <tr>
              <th>年　　龄：</th>
              <td><input type="text" name="xm_age"  ></td>
            </tr>
            <tr>
              <th>分    院：</th>
           ...
           <tr>
             ...
             <tr>
              <th>联系方式：</th>
              <td><input type="text" name="xm_phone"></td>
            </tr>
            
             <tr>
              <th>签到日期：</th>
              <td><input type="text" name="xm_scqd" ></td>
            </tr>
           
           
            <tr>
              <th>签订期限：</th>
              <td><input type="text" name="xm_sczz" ></td>
            </tr>
            <tr>
              <th>签订年数：</th>
              <td><input type="text" name="xm_ns" ></td>
            </tr>
            <tr>
              <th>试用工资：</th>
              <td><input type="text" name="xm_salary" ></td>
            </tr>
...
$sql = "SELECT * FROM yuanxi_zsht_xm LIMIT $start_from, $num_rec_per_page"; 
...
?> 
            ...
            <td align="center"><?php echo $row['xm_gender']; ?></td>   
            <td align="center"><?php echo $row['xm_age']; ?></td>   
            <td align="center"><?php echo $row['xm_fenyuan']; ?></td>  
               <td align="center"><?php echo $row['xm_zc']; ?></td>  
            <td align="center"><?php echo $row['xm_sfzh']; ?></td> 
              <td align="center"><?php echo $row['xm_phone']; ?></td>   
            <td align="center"><?php echo $row['xm_scqd']; ?></td>   
            <td align="center"><?php echo $row['xm_sczz']; ?></td>   
            <td align="center"><?php echo $row['xm_ns']; ?></td> 
             <td align="center"><?php echo $row['xm_salary']; ?></td>   
