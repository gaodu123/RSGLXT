        ...
        <form action="jidian_add.php" method="post" enctype="multipart/form-data">
          <table class="table">
           ...
           <tr>
             ...
             <tr>
              <th>签到日期：</th>
              <td><input type="text" name="jd_scqd" ></td>
            </tr>
           
           
            <tr>
              <th>签订期限：</th>
              <td><input type="text" name="jd_sczz" ></td>
            </tr>
            <tr>
              <th>签订年数：</th>
              <td><input type="text" name="jd_ns" ></td>
            </tr>
            <tr>
              <th>正式工资：</th>
...
$sql = "SELECT * FROM yuanxi_zsht_jd LIMIT $start_from, $num_rec_per_page"; 
...
?> 
            ...
            <td align="center"><?php echo $row['jd_scqd']; ?></td>   
            <td align="center"><?php echo $row['jd_sczz']; ?></td>   
            <td align="center"><?php echo $row['jd_ns']; ?></td> 
