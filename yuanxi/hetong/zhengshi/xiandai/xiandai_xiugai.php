                      ...
                      <tr>
                        ...
                        <tr>
						 ...
						 <tr>
                          ...
                          <tr>
							<th>联系方式：</th>
							<td><input type="text" name="xd_phone" value="<?php echo $arr["xd_phone"] ?>"></td>
						</tr>

						<tr>
							<th>签到日期：</th>
							<td><input type="text" name="xd_scqd" size="11" value="<?php echo $arr["xd_scqd"] ?>"></td>
						</tr>

                      
                        <tr>
							<th>签订期限：</th>
							<td><input type="text" name="xd_sczz" size="25" value="<?php echo $arr["xd_sczz"] ?>"></td>
						</tr>
						...
						<tr>
							<th>签订年数：</th>
							<td><input type="text" name="xd_ns" size="25" value="<?php echo $arr["xd_ns"] ?>"></td>
						</tr>
