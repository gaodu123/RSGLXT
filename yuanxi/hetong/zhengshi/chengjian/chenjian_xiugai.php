                      ...
                      <tr>
                        ...
                        <tr>
						 ...
						 <tr>
                          ...
                          <tr>
							<th>联系方式：</th>
							<td><input type="text" name="cj_phone" value="<?php echo $arr["cj_phone"] ?>"></td>
						</tr>

						<tr>
							<th>签到日期：</th>
							<td><input type="text" name="cj_scqd" size="11" value="<?php echo $arr["cj_scqd"] ?>"></td>
						</tr>

                      
                        <tr>
							<th>签订期限：</th>
							<td><input type="text" name="cj_sczz" size="25" value="<?php echo $arr["cj_sczz"] ?>"></td>
						</tr>
						...
						<tr>
							<th>签订年数：</th>
							<td><input type="text" name="cj_ns" size="25" value="<?php echo $arr["cj_ns"] ?>"></td>
						</tr>
