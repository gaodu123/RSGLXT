...
$jj_salary = $_POST['jj_salary'];
	...
	// 参数绑定，并为已经绑定的变量赋值
	mysqli_stmt_bind_param($stmt, 'ssssssssssss', $jj_name, $jj_gender, $jj_age,  $jj_fenyuan ,$jj_zc, $jj_sfzh, $jj_phone,  $jj_scqd ,$jj_sczz,$jj_ns,$jj_salary,$jj_id);
