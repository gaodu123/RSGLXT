...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="zhengshi/xinxi/xinxi.php" target="topifr">信息技术分院</a></li>
        <li><a href="zhengshi/xiandai/xiandai.php" target="topifr">现代农业分院</a></li>
        <li><a href="zhengshi/yuanlin/yuanlin.php" target="topifr">园林园艺分院</a></li>
        <li><a href="zhengshi/xumu/xumu.php" target="topifr">畜牧兽医分院</a></li>
        <li><a href="zhengshi/chengjian/chenjian.php" target="topifr">城乡建设分院</a></li>
        <li><a href="zhengshi/jinguan/jinguan.php" target="topifr">经济管理分院</a></li>
        <li><a href="zhengshi/jidian/jidian.php" target="topifr">机电技术分院</a></li>
    </ul>
</div>
  </div>
</div>
...
<tr>
    ...
    <!-- 右侧内容 -->
        <td width="80%"><iframe width="100%" height="600" frameborder="0" marginheight="0" marginwidth="0" name="topifr"  src='zhengshi/xinxi/xinxi.php'>
